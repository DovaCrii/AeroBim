...
| **Memoria**           | Un archivo de 200 MB se lee **entero en RAM** para subirlo y otra vez para descargarlo, y hay `cpu*2+1` workers                                                                                                        | el primer día de uso real | **`GUNICORN_WORKERS` según la RAM y no según los núcleos.** Con 4 GB, tres                                                       |
