  ...
  return (
    <div className="pointer-events-none absolute inset-0 flex items-center justify-center p-6">
      <div className="flex max-w-sm flex-col items-center gap-3 text-center">
        ...
        <h2 className="text-lg leading-tight font-medium text-fg">Abre algo para empezar</h2>
        <p className="text-sm text-fg-2">
          Un modelo <span className="text-fg">IFC</span>, el plano{" "}
          <span className="text-fg">DXF</span> del proyecto, o el{" "}
          <span className="text-fg">levantamiento</span> de la obra.
        </p>
        ...
        <p className="text-nota text-fg-3">o arrastra el archivo a cualquier parte del lienzo</p>
      </div>
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={[
        ...
        deshabilitado
          ? "border border-borde text-apagado-fg"
          : primario
